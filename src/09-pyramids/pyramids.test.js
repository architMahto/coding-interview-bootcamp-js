...
import { iterativePyramids, recursivePyramids } from './pyramids';
...
describe.only('Testing the recursivePyramids method', function () {
	beforeEach(function () {
		spy(console, 'log');
	});

	it('should exist', function () {
		expect(recursivePyramids).to.not.be.undefined;
	});
